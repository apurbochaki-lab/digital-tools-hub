    ...
    return (
        <section className="mt-3 md:mt-30 bg-[#F9FAFC]">
            <div className="container mx-auto space-y-8 mb-20 py-30">
                <div className="text-center space-y-3 m-3">
                ...
                {/* Card Container */}
                <div className="grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-3 md:gap-20 m-5">
                    {/* Card */}
                    {/* max-w-100 mx-auto md:w-full */}
                    {
                        steps.map(step => <div key={step.id} className=" border border-gray-500/40 shadow-md h-auto p-5 rounded-xl">
                            <span className="flex justify-end">
                                <p className="primary-bg w-10 h-10 rounded-full text-white font-bold flex justify-center items-center">{step.step}</p>
                            </span>

                            <div className="flex flex-col justify-center items-center space-y-3 py-10 mb-5">
                                ...
                                <p className="text-center font-medium text-[#627382]">{step.description}</p>
                            </div>
                        </div>
                        )
                    }
